...
function attachRooms(ctx) {
  ...
  function seedRooms() {
    ...
    const rooms = [
      ...
      { id: "r_demo_lounge", name: "General", topic: "Other", privacy: "public", desc: "Open table. Say hello, ask anything.", members: ["u_demo_vito", "u_demo_kay"], ownerId: "u_demo_vito" },
      { id: "r_demo_welcome", name: "Welcome", topic: "Other", privacy: "public", desc: "New here? Start in this room.", members: ["u_demo_kay"], ownerId: "u_demo_kay" },
      { id: "r_demo_sports", name: "Sports Talk", topic: "Sports", privacy: "public", desc: "Scores, watch parties, Denver games.", members: ["u_demo_sonny"], ownerId: "u_demo_sonny" },
      { id: "r_demo_music", name: "Music", topic: "Music", privacy: "public", desc: "Playlists, concerts, what is on the stereo.", members: ["u_demo_connie"], ownerId: "u_demo_connie" },
      { id: "r_demo_movies", name: "Movies & TV", topic: "Movies", privacy: "public", desc: "What we are watching this week.", members: ["u_demo_michael"], ownerId: "u_demo_michael" },
      { id: "r_demo_gaming", name: "Gaming", topic: "Gaming", privacy: "public", desc: "Co-op nights, steam codes, party up.", members: ["u_demo_sonny"], ownerId: "u_demo_sonny" },
      { id: "r_demo_travel", name: "Travel", topic: "Travel", privacy: "public", desc: "Trips, rides to the airport, packing lists.", members: ["u_demo_kay"], ownerId: "u_demo_kay" },
      { id: "r_demo_books", name: "Book Club", topic: "Books", privacy: "public", desc: "What we are reading. No spoilers in the title.", members: ["u_demo_tom"], ownerId: "u_demo_tom" },
      { id: "r_demo_garden", name: "Gardening", topic: "Gardening", privacy: "public", desc: "Tomatoes, herbs, who has extra soil.", members: ["u_demo_connie"], ownerId: "u_demo_connie" },
      { id: "r_demo_faith", name: "Faith", topic: "Faith", privacy: "public", desc: "Quiet room. Be kind.", members: ["u_demo_kay"], ownerId: "u_demo_kay" },
      { id: "r_demo_fishing", name: "Fishing", topic: "Fishing", privacy: "public", desc: "Lakes, bait, who is up before dawn.", members: ["u_demo_clemenza"], ownerId: "u_demo_clemenza" },
      { id: "r_demo_parents", name: "Parents", topic: "Other", privacy: "public", desc: "Carpools, school, bedtime wins.", members: ["u_demo_kay", "u_demo_connie"], ownerId: "u_demo_kay" },
      { id: "r_demo_hood", name: "Neighborhood", topic: "Other", privacy: "public", desc: "Local tips. Not a map — just chat.", members: ["u_demo_tessio"], ownerId: "u_demo_tessio" }
    ];
    let changed = false;
    rooms.forEach((r) => {
    ...
    if (!DB.settings.demoRoomsSeeded) {
